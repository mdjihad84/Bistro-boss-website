...
const BistroBoss = () => {
    return (
        <div className="w-[1300px] h-[400px] md:w-[1320px] mx-auto mt-20 relative mb-20 bg-fixed overflow-y-scroll" style={{ backgroundImage: `url(${Img5})`,backgroundRepeat:`no-repeat`}} aria-label="Product 5">
